...
//		y si en parametros (3170, 3171) esta activado estos mensajes 
	...
	@Override
	public String generarClaveAcceso(Sucursal sucursal, String fechaEmision, String codigoDocu, String serie1,
...
//		}
	...
	public InfoFactura cargarInfoFactura(Egreso egreso, String codigoIva, String codigoIce, String codigoIrbpnr,
		...
		String fechaEmision = Util.cambiarFormatoFechaString(egreso.getFechaEmis(), "dd/MM/yyyy");
	...
	public InfoNotaCredito cargarInfoNotaCredito(Egreso egreso, String codigoIva, String codigoIce, String codigoIrbpnr,
		...
		String fechaEmisionDocSusento = Util.cambiarFormatoFechaString(egreso.getEgreso().getFechaEmis(), "dd/MM/yyyy");

		infoNotaCredito.setCodDocModificado(egreso.getDocuEgre().getDimm().getCodigo());
		infoNotaCredito.setNumDocModificado(numDocModificado);
		infoNotaCredito.setFechaEmisionDocSustento(fechaEmisionDocSusento);
	...
	public InfoNotaDebito cargarInfoNotaDebito(Egreso egreso, List<TotalDocu> totalDocus, FpmeFormPago fpmeFormPago) {
		...
		infoNotaDebito.setCodDocModificado(egreso.getEgreso().getDocuEgre().getDimm().getCodigo());
		infoNotaDebito.setNumDocModificado(numDocModificado);
		infoNotaDebito.setFechaEmisionDocSustento(fechaEmisionDocSusento);
	...
	public InfoLiquidacionCompra cargarInfoLiquidacion(Ingreso ingreso, String codigoIva, 
		...
		String fechaEmision = Util.cambiarFormatoFechaString(ingreso.getFechaRegi(), "dd/MM/yyyy");
		...
		infoLiquidacionCompra.setFechaEmision(fechaEmision);
...
//		entonces de estos negativos se suma su valor absoluto
	...
	public InfoCompRetencion cargarInfoComprobanteRetencion(Ingreso ingreso) {
		...
		String fechaEmision = Util.cambiarFormatoFechaString(ingreso.getFechaRegi(), "dd/MM/yyyy");
		String periodoFiscal = Util.cambiarFormatoFechaString(ingreso.getFechaRegi(), "MM/yyyy");
...
//		Opcional y poner los 15 caracteres incluir cero a la izquierda
		...
		String fecha = Util.cambiarFormatoFechaString(ingreso.getFechaEmis(), "dd/MM/yyyy");
		docSustento.setFechaEmisionDocSustento(fecha);
//		Opcional
		fecha = Util.cambiarFormatoFechaString(ingreso.getFechaRegi(), "dd/MM/yyyy");
		docSustento.setFechaRegistroContable(fecha);
//		Opcional
