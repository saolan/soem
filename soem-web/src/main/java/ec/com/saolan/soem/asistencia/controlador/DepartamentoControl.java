...
public class DepartamentoControl extends PaginaControl implements Serializable {
	...
	public String eliminar() {
		...
		try {
			Departamento departamento = departamentoRegis.buscarPorId(this
					.getId());
	...
	public void preCargarLista() {
		...
		try {
			...
			this.departamentos = departamentoLista.buscar(this.departamento,
					this.pagina);
			this.numeroReg = departamentos.size();
			this.contadorReg = departamentoLista
					.contarRegistros(this.departamento);
		} catch (Exception e) {
			FacesContext.getCurrentInstance().addMessage(
					null,
					new FacesMessage(FacesMessage.SEVERITY_FATAL, null,
	...
	public void preCargarRegExp() {
		...
		if (this.id == null) {
			...
			try {
				this.departamento = departamentoRegis.buscarPorId(this.getId());
			} catch (Exception e) {
				FacesContext.getCurrentInstance().addMessage(
						null,
						new FacesMessage(FacesMessage.SEVERITY_FATAL, null,
