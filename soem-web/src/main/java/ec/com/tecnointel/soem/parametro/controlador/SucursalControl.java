...
//				Este campo se elimino de la pantalla
	...
	public List<Sucursal> buscarTodo() {
		...
		try {
			sucursales = sucursaLista.buscarTodo("descri");
		} catch (Exception e) {
			FacesContext.getCurrentInstance().addMessage(null,
...
//	public void buscarSucuBodes(Sucursal sucursal){
//		
//		SucuBode sucuBode = new SucuBode();
//		sucuBode.setSucursal(sucursal);
...
//	}
//	
//	public void buscarSucuPrec(Sucursal sucursal){
//		
