...
//		Recorre rolPerm para determinar cual tiene acceso true
	...
	public void cargarFactElecVentaAuto() {
		...
		if (parametro.getDescri().equals("true")) {
			variablesSesion.setFactElecVentaAuto(true);
		} else {
			variablesSesion.setFactElecVentaAuto(false);
		}
	}
	...
	public void cargarFactElecCompraAuto() {
		...
		if (parametro.getDescri().equals("true")) {
			variablesSesion.setFactElecCompraAuto(true);
		} else {
			variablesSesion.setFactElecCompraAuto(false);
		}
	}
