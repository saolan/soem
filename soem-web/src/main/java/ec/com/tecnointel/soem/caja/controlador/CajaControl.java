...
//	Esto no funciono porque segun la documentacion se necesita otra version de Hibernate
//	pero aun cambiando la version tampoco funciono
//	public void buscarCajas() {
//		
//		List<Tuple> tuples;
//		try {
//			tuples = cajaLista.buscarCajas();
