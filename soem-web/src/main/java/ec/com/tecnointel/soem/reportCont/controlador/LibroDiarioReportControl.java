...
public class LibroDiarioReportControl extends ContabilidadModuloControl implements Serializable {
	...
	public void descargar() {
		...
		try {
			...
			parametrosJasper.put("transaccionFechaDesd", this.getTransaccionDesd().getFechaEmis());
			parametrosJasper.put("transaccionFechaHast", this.getTransaccionHast().getFechaEmis());
