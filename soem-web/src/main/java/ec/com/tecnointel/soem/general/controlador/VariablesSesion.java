...
//	Parámetros facturación electrónica
	...
	private boolean factElecVentaAuto;
	private boolean factElecCompraAuto;
...
//	Para consultar esta lista al momento de abrir cada una de las paginas del sistema
	...
	public boolean isFactElecVentaAuto() {
		return factElecVentaAuto;
	}

	public void setFactElecVentaAuto(boolean factElecVentaAuto) {
		this.factElecVentaAuto = factElecVentaAuto;
	}

	public boolean isFactElecCompraAuto() {
		return factElecCompraAuto;
	}

	public void setFactElecCompraAuto(boolean factElecCompraAuto) {
